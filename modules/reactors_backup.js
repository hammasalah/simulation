...
// ============================================================================
function rk4(dydx, x0, y0, xf, step) {
    let x = x0;
    ...
    return `
        ...
        <div class="reactors-module" id="reactors-content">
            <div class="d-flex justify-between align-center mb-5">
                <div>
                    <h2>Ssimulation de Réacteurs Chimiques v2.0</h2>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 20px;">
                ...
                <div>
                    ...
                    <div class="card" style="height: 300px;">
                        <div class="card-body h-full relative" id="chart-area">
...
ReactorsModule.init = function() {
    ...
    window.setRType = (type) => {
        ...
        document.getElementById('pbr-params').style.display = type === 'pbr' ? 'block' : 'none';
    ...
    window.switchRTab = (tab) => {
        ['kinetics', 'energy', 'phys'].forEach(t => {
            ...
            document.getElementById(`tab-${t[0]}`).classList.toggle('active', t === tab);
        });
    };

    document.getElementById('rxn-scheme').addEventListener('change', (e) => {
        document.getElementById('grp-k2').style.display = e.target.value === 'AtoBtoC' ? 'block' : 'none';
    });
    ...
    window.runRxnSim = () => {
        const params = {
            reactorType: window.currentRType,
            reactionScheme: document.getElementById('rxn-scheme').value,
        ...
        document.getElementById('res-x').innerText = (final.Conversion*100).toFixed(1);
        const sel = final.Cb / (final.Ca + final.Cb + final.Cc + 0.0001) * 100;
        document.getElementById('res-sel').innerText = sel.toFixed(1);
        document.getElementById('res-t').innerText = final.T.toFixed(1);
        document.getElementById('res-dp').innerText = ((1 - final.P)*100).toFixed(1);
